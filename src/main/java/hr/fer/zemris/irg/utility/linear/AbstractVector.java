...
import hr.fer.zemris.irg.utility.linear.interfaces.UnmodifiableObjectException;
...
public abstract class AbstractVector implements IVector {
	...
	public String toString(int decimals) {
		...
		double value = 0;
		for (int i = 0; i < size; i++) {
			value = Math.abs(this.get(i)) > EPSILON ? this.get(i) : 0.0;
