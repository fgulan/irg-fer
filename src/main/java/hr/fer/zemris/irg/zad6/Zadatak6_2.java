 ...
 * @author Filip Gulan
 */
public class Zadatak6_2 extends JFrame implements GLEventListener {
    static {
    ...
    public Zadatak6_2(ObjectModel model) {
        this.model = model;
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        double near = 1;
        double hDistance = 1;
        double fovy = Math.atan(hDistance/(2 * near)) * 2;
        glu.gluPerspective(Math.toDegrees(fovy), 1, near, 100);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            final JFrame frame = new Zadatak6_2(model);
